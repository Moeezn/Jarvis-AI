...
from Backend.Translator import translate_text  # Import the translation function
...
def MainExecution():
    try:
        ...
        TranslationExecution = False  # New flag for translation
        TranslationResult = None      # Store translation result
            ...
            if "translate" in query.lower():
                ...
                if "to" in query.lower():
                    ...
                    if len(parts) == 2:
                        ...
                        TranslationResult = translate_text(text_to_translate, target_language)
                        TranslationExecution = True
                else:
                    # Default to English if no target language specified
                    text_to_translate = query.replace("translate", "").strip().strip("'\"")
                    TranslationResult = translate_text(text_to_translate, "english")
                    TranslationExecution = True
